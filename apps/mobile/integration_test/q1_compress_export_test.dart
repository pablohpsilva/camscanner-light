...
import './../test/step/i_export_the_page_as_an_image_at_medium_quality.dart';
import './../test/step/i_see_the_image_export_confirmation.dart';

void main() {
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();

  group('''Q1 Compress / export quality''', () {
    testWidgets('''Choosing a quality when exporting a page as an image''',
        (tester) async {
      ...
      await iExportThePageAsAnImageAtMediumQuality(tester);
