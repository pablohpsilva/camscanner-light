...
/// Usage: the library has a document "Invoice" with no folder
///
/// Seeds an in-memory [FakeDocumentRepository] (created lazily and shared via
/// [bddOrganizeRepo] with any other seed step in the same scenario) with an
/// unfiled document named "Invoice". See organize_actions_bdd_state.dart for
/// why this scenario uses a fake repository instead of a real Drift DB.
Future<void> theLibraryHasADocumentInvoiceWithNoFolder(
  WidgetTester tester,
) async {
