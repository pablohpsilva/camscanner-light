...
import './../step/i_do_not_see_the_donation_banner.dart';
import './../step/i_open_settings_from_home.dart';
import './../step/i_do_not_see_the_support_row.dart';
...
void main() {
  group('''Donation entry points respect the platform''', () {
    testWidgets('''Donation entry points are hidden on iOS''', (tester) async {
      await thePlatformIsIos(tester);
      await theHomeScreenIsShown(tester);
      await iDoNotSeeTheDonationBanner(tester);
