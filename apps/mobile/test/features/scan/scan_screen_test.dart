...
void main() {
  ...
  testWidgets(
    'retake mode: single page → onCapture via camera, never touches scanner',
    (tester) async {
      final repo = FakeDocumentRepository();
        ...
        _host(
          ScanScreen(
            dependencies: ScanDependencies(
              ...
              createPhotoCamera: () =>
                  FakePhotoCamera(const ['/nonexistent/re.jpg']),
      ...
      expect(fakeScanner.scanCalls, 0); // scanner never called in retake mode
