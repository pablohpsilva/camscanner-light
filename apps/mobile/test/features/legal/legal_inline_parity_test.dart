...
void main() {
  test('parseLegalInline matches the JS tokenisation of every shipped string', () {
    ...
    expect(file.existsSync(), isTrue,
        reason: 'fixture missing — run node libs/legal-content/src/inline-parity-fixture.mjs');
    ...
    for (final c in cases) {
      ...
      if (jsonEncode(actual) != jsonEncode(expected)) {
        mismatches.add('  input: $input\n    js  : ${jsonEncode(expected)}\n    dart: ${jsonEncode(actual)}');
      }
    }

    expect(mismatches, isEmpty,
        reason: '${mismatches.length} of ${cases.length} strings diverged:\n'
